...
export default function Dashboard() {
  ...
  function goTo(r: SearchResult): void {
    ...
    else if (r.type === "item" && r.containerId != null)
      navigate(`/containers/${r.containerId}#item-${r.refId}`);
    ...
    <>
      ...
      <main className="p-4 sm:p-6">
        ...
        <section style={{ marginBottom: "1.5rem" }}>
          ...
          {trimmed.length > 0 && (
            <div
              data-testid="dashboard-search-count"
              className={`${muted} mt-2 text-sm`}
            >
              {t(
                "topos.page.dashboard.result_count",
                "{count} Ergebnisse",
