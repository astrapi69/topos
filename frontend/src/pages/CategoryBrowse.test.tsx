...
describe("CategoryBrowse", () => {
    beforeEach(async () => {
        ...
        renameMock.mockResolvedValue({
            ...
            category: {id: 1, path: "money", parentPath: null, name: "money", displayName: "Finanzen", level: 0},
        });
        deleteMock.mockResolvedValue({deleted: true, itemsOrphaned: 1, subcategoriesDeleted: 0});
        await db.categories.clear();
    ...
    it("hides rename and delete actions in offline mode", async () => {
        ...
        expect(screen.queryByTestId("category-rename-finance")).not.toBeInTheDocument();
        expect(screen.queryByTestId("category-delete-finance")).not.toBeInTheDocument();
    });
