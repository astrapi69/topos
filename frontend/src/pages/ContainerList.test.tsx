...
describe("ContainerList", () => {
  ...
  it("opens the create form and submits a new container", async () => {
    ...
    fireEvent.change(screen.getByTestId("container-form-external-id"), {
      target: { value: "5005" },
    });
    fireEvent.change(screen.getByTestId("container-form-label"), {
      target: { value: "Neuer Ordner" },
    });
    fireEvent.change(screen.getByTestId("container-form-type"), {
      target: { value: "box" },
    });
  ...
  it("prefills the form on edit and disables the external id", async () => {
    ...
    const externalId = screen.getByTestId(
      "container-form-external-id",
    ) as HTMLInputElement;
