...
export default function ItemEditor() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (containerId === null) {
      notify.warning(
        t(
          "topos.page.item_editor.container_required",
          "Container ist erforderlich.",
        ),
      );
      return;
    }
    if (!content.trim()) {
      notify.warning(
        t(
          "topos.page.item_editor.content_required",
  ...
  return (
    <>
      ...
      <main className="p-4 sm:p-6 max-w-3xl">
        ...
        {loading && (
          <p data-testid="item-editor-loading">
