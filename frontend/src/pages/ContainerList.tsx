    ...
    return data.filter((c) => {
      ...
      if (needle.trim()) {
        ...
        if (
          ...
          !(c.location ?? "").toLowerCase().includes(n)
        ) {
          return false;
        }
      }
    ...
    try {
      if (editingId === null) {
        ...
        if (!form.externalId.trim() || !Number.isInteger(externalId)) {
          notify.warning(
            t(
              "topos.page.containers.external_id_invalid",
              "Nr. muss eine ganze Zahl sein.",
            ),
          );
          setSaving(false);
          return;
        ...
        >
          ...
          <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
            ...
            <button
              ...
              data-testid="container-new-button"
              onClick={openCreate}
            >
        ...
        {showForm && (
          ...
          >
            <h2
              ...
              data-testid="container-form-title"
            >
              {editingId === null
            ...
            <FormField label={t("topos.container.size_group", "Größengruppe")}>
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, sizeGroup: e.target.value }))
                }
              />
            </FormField>
            <div style={{ display: "flex", gap: "0.5rem" }}>
              ...
              <button
                type="button"
                className={btn}
                data-testid="container-form-cancel"
                onClick={closeForm}
              >
        ...
        >
          ...
          {filtered.map((c) => (
            ...
            >
              ...
              <div>
                <span className={cellLabel}>
                  {t("topos.container.location", "Ort")}:{" "}
                </span>
                {c.location ?? ""}
              </div>
