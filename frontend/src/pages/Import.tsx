...
export default function Import() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      notify.success(t("topos.toast.import_done", "Import abgeschlossen"));
    } catch (err) {
      notify.error(
        errorMessage(
          err,
        ...
        {report && (
          ...
          >
            ...
            >
              ...
              <ReportRow
                label={t(
                  "topos.import.report.containers_updated",
              ...
              <ReportRow
                label={t(
                  "topos.import.report.items_updated",
              ...
              <ReportRow
                label={t(
                  "topos.import.report.items_pruned",
                  "Einträge entfernt",
                )}
              ...
              <ReportRow
                label={t(
                  "topos.import.report.categories_created",
                  "Kategorien neu",
                )}
            ...
            {report.warnings.length > 0 && (
              ...
              >
                <summary>
                  {t("topos.import.report.warnings", "Warnungen")} (
