...
function matchesCombo(event: KeyboardEvent, keys: string): boolean {
  ...
  const key = parts.filter(
    (p) => !["ctrl", "mod", "shift", "alt"].includes(p),
  )[0];
  if (!key) return false;
  ...
  useEffect(() => {
    const handler = (event: KeyboardEvent) => {
      for (const shortcut of shortcutsRef.current) {
        ...
        const hasMod =
          shortcut.keys.toLowerCase().includes("ctrl") ||
...
export const APP_SHORTCUTS: Array<{
  keys: string;
  labelKey: string;
  ...
  {
    keys: "Ctrl+/",
    labelKey: "ui.shortcuts.show_shortcuts",
    labelFallback: "Shortcuts anzeigen",
    section: "app",
  },
  {
    keys: "Ctrl+H",
    labelKey: "ui.shortcuts.search_replace",
    labelFallback: "Suchen & Ersetzen",
    section: "editor",
  },
  // Editor formatting (from TipTap, listed for reference)
  {
    keys: "Ctrl+B",
    labelKey: "ui.shortcuts.bold",
    labelFallback: "Fett",
    section: "editor",
  },
  {
    keys: "Ctrl+I",
    labelKey: "ui.shortcuts.italic",
    labelFallback: "Kursiv",
    section: "editor",
  },
  {
    keys: "Ctrl+U",
    labelKey: "ui.shortcuts.underline",
    labelFallback: "Unterstrichen",
    section: "editor",
  },
  {
    keys: "Ctrl+Shift+X",
    labelKey: "ui.shortcuts.strikethrough",
    labelFallback: "Durchgestrichen",
    section: "editor",
  },
  {
    keys: "Ctrl+E",
    labelKey: "ui.shortcuts.code",
    labelFallback: "Inline-Code",
    section: "editor",
  },
  {
    keys: "Ctrl+Shift+1",
    labelKey: "ui.shortcuts.heading1",
    labelFallback: "Überschrift 1",
    section: "editor",
  },
  {
    keys: "Ctrl+Shift+2",
    labelKey: "ui.shortcuts.heading2",
    labelFallback: "Überschrift 2",
    section: "editor",
  },
  {
    keys: "Ctrl+Shift+3",
    labelKey: "ui.shortcuts.heading3",
    labelFallback: "Überschrift 3",
    section: "editor",
  },
  {
    keys: "Ctrl+Shift+8",
    labelKey: "ui.shortcuts.bullet_list",
    labelFallback: "Aufzählung",
    section: "editor",
  },
  {
    keys: "Ctrl+Shift+9",
    labelKey: "ui.shortcuts.ordered_list",
    labelFallback: "Nummerierte Liste",
    section: "editor",
  },
  {
    keys: "Ctrl+Shift+B",
    labelKey: "ui.shortcuts.blockquote",
    labelFallback: "Zitat",
    section: "editor",
  },
  {
    keys: "Ctrl+Z",
    labelKey: "ui.shortcuts.undo",
    labelFallback: "Rückgängig",
    section: "editor",
  },
  {
    keys: "Ctrl+Y",
    labelKey: "ui.shortcuts.redo",
    labelFallback: "Wiederherstellen",
    section: "editor",
  },
];
