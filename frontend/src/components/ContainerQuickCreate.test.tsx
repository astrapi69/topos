...
describe("ContainerQuickCreate", () => {
  it("starts collapsed and expands to the required-fields form", () => {
    ...
    fireEvent.click(screen.getByTestId("container-quick-create-toggle"));
    expect(
      screen.getByTestId("container-quick-create-form"),
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("container-quick-create-external-id"),
    ).toBeInTheDocument();
    expect(screen.getByTestId("container-quick-create-type")).toHaveValue(
      "box",
    );
    expect(screen.getByTestId("container-quick-create-owner")).toHaveValue(
      "self",
    );
    expect(
      screen.getByTestId("container-quick-create-label"),
    ).toBeInTheDocument();
  });
