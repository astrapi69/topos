...
export default function OrphanPathsSection() {
    ...
    async function assignPath(item: OrphanedItem, path: string | null): Promise<void> {
        setBusy(true);
        try {
            ...
            notify.error(
                errorMessage(e, t("topos.toast.item_save_failed", "Eintrag konnte nicht gespeichert werden")),
                e,
            );
        } finally {
            setBusy(false);
    ...
    async function removeAll(): Promise<void> {
        ...
        const ok = await confirm(
            ...
            "danger",
            {
                confirmLabel: t("topos.category.orphans_remove_all", "Alle Pfade entfernen"),
