...
export function DialogProvider({ children }: { children: React.ReactNode }) {
  ...
  const showDialog = useCallback(
    (options: DialogOptions): Promise<string | boolean | null> => {
  ...
  const alert = useCallback(
    (title: string, message: string, variant?: DialogVariant) => {
              ...
              <>
                ...
                {dialog.type === "prompt" && (
                  <input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" && inputValue.trim() && handleConfirm()
                    }
                    ...
                    <>
                      ...
                      >
                        {dialog.confirmLabel ||
                          (dialog.type === "alert"
                            ? "OK"
                            : t("ui.common.confirm", "Bestätigen"))}
                      </button>
                    </>
                  )}
                </div>
