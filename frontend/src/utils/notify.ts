      ...
      "button",
      {
        ...
        onClick: (e: React.MouseEvent) => {
          ...
          window.dispatchEvent(
            new CustomEvent("topos:open-error-report", {
...
function SaveErrorContent({
  ...
  return React.createElement(
    ...
    React.createElement(
      "span",
      { style: { display: "block", fontSize: "0.8125rem", lineHeight: 1.4 } },
      message,
    ),
    React.createElement(
      "button",
...
export const notify = {
  error: (message: string, apiError?: unknown) => {
    ...
    return toast.error(
      React.createElement(ErrorContent, { message, apiError: err }),
      {
        autoClose: 15000,
        closeOnClick: false,
      },
  ...
  warning: (message: string) => {
    ...
    return toast.warning(message, { autoClose: 12000 });
  },
  info: (message: string) => {
    recordToast("info", message);
    return toast.info(message, { autoClose: 10000 });
  },
