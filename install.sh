...
VERSION="${TOPOS_VERSION:-v0.0.0-template}"
...
if [ -d "$INSTALL_DIR/.git" ]; then
    echo -e "${YELLOW}Topos is already installed in ${INSTALL_DIR}${NC}"
...
echo -e "${BLUE}Downloading Topos ${VERSION}...${NC}"
...
# --- Build and start ---
echo ""
echo -e "${BLUE}Building and starting Topos (this may take a few minutes the first time)...${NC}"
echo ""
...
echo ""
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  Topos is running!${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
